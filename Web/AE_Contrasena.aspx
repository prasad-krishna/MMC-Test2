...
<head>
 ...
 <%--   <script type="text/javascript">
    ...
    window.addEventListener("beforeunload", function (e) {
        ...
        xmlHttp.open("POST", "interfaz_empleado/Forma/WfPage_Load.aspx", false); // false for synchronous request
        xmlHttp.send(null);
                                                    ...
                                                    <table id="Table5" cellspacing="0" cellpadding="3" width="100%" border="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="height: 24px">
                                                                <asp:TextBox ID="txtActual" runat="server" MaxLength="32" CssClass="textBox" TextMode="Password" AutoCompleteType="Disabled" autocomplete="off"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtNueva" runat="server" MaxLength="32" CssClass="textBox" TextMode="Password" AutoCompleteType="Disabled" autocomplete="off"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtConfirmacion" runat="server" MaxLength="32" CssClass="textBox"
                                                        ...
                                                        <tr>
                                                            <td colspan="2" height="20">
                                                                ...
                                                                <asp:RegularExpressionValidator ID="revCaracteresEspeciales" runat="server" CssClass="textRed"
                                                                    ControlToValidate="txtNueva" Display="Dynamic" ForeColor=" " ErrorMessage="La contraseña debe estar entre 15 y 32 caracteres, contener al menos un número y una letra y no debe contener caracteres especiales."
                                                        ...
                                                        <tr>
                                                            <%--<td height="20" colspan="2" class="textSmallBlack">
                                                                La nueva contraseña debe tener mínimo 15 y máximo 17 caracteres, por lo menos una
