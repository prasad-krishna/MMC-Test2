 ...
 * == END LICENSE ==
 *
 * Defines and renders a Menú items in a Menú block.
 */
...
FCKMenuItem.prototype.Create = function( parentTable )
{
	...
	// Add a row in the table to hold the Menú item.
	...
	// Create the arrow cell and setup the sub Menú panel (if needed).
	eCell = r.insertCell(-1) ;
	if ( bHasSubMenu )
	{
...
FCKMenuItem.prototype.Activate = function()
{
	...
	if ( this.HasSubMenu )
	{
		// Show the child Menú block. The ( +2, -2 ) correction is done because
