...
<%@ Page language="c#" Codebehind="FO_RemisionesOrden.aspx.cs" AutoEventWireup="false" Inherits="TPA.interfaz_empleado.formatos.FO_RemisionesOrden" %>
								...
								<TR>
									<TD align="right">
										...
										<TABLE class="tableFormato" id="Table15" cellSpacing="0" cellPadding="0" width="200" border="0"
											height="25">
											<TR>
												<TD><STRONG><asp:Label runat="server" ID="lblTituloTotal">TOTAL</asp:Label></STRONG></TD>
												<TD></TD>
												<TD width="20"></TD>
											</TR>
										</TABLE>
											...
											<TR>
												<TD align="left" width="30%">
													<TABLE class="tableBorderFormato" id="Table6" width="100%" border="0">
														<TR>
															<TD vAlign="top" height="45">Servicio Autorizado por</TD>
														</TR>
														<TR>
												...
												<TD align="right" width="12%">
												 <asp:Panel runat="server" ID="pnlTotal" Visible=true>
