                                        ...
                                        <table cellspacing="0" cellpadding="3">
                                            ...
                                            <tr>
                                                ...
                                                <td class="style5">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="revCaracteresEspeciales" runat="server" CssClass="textRed"
                                                        ControlToValidate="txtContrasena" Enabled="false" Display="Dynamic" ErrorMessage="La contraseña debe estar entre 8 y 10 caracteres, contener al menos un número y una letra y no debe contener caracteres especiales."
                                                ...
                                                <td class="List">
                                                    <asp:TextBox ID="txtConfContrasena" runat="server" Width="100px" CssClass="textBox"
                                                        TextMode="Password" TabIndex="6" MaxLength="10" AutoCompleteType="Disabled" autocomplete="off"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td height="20" colspan="4" class="textSmallBlack" style="color: #2f4f64">
                                                    La contraseña debe tener mínimo 8 y máximo 10 caracteres, una letra mayúscula, una
                                                    letra minúscula, un número y al menos uno de los siguientes caracteres especiales:.,:;()[]{}?!¿¡@-_/\#.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
