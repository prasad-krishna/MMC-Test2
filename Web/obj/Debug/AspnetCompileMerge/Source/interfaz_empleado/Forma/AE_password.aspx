                            ...
                            <table id="Table1" cellspacing="0" cellpadding="3" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td style="height: 24px">
                                        <asp:TextBox ID="txtActual" runat="server" TextMode="Password" MaxLength="15" CssClass="textBox" AutoCompleteType="Disabled" autocomplete="off"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNueva" runat="server" TextMode="Password" MaxLength="10" CssClass="textBox" AutoCompleteType="Disabled" autocomplete="off"> </asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtConfirmacion" runat="server" TextMode="Password" MaxLength="10"
                                ...
                                <tr>
                                    <td colspan="2" height="20">
                                        ...
                                        <asp:RegularExpressionValidator ID="revContrasena" runat="server" CssClass="textRed"
                                            ErrorMessage="La contraseña debe estar entre 8 y 10 caracteres, contener al menos un número y una letra y no debe contener caracteres especiales."
