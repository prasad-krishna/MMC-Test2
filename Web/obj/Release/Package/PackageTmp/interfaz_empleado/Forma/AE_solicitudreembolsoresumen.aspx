...
<%@ Page language="c#" Codebehind="AE_solicitudreembolsoresumen.aspx.cs" AutoEventWireup="false" Inherits="TPA.interfaz_empleado.forma.AE_solicitudreembolsoresumen" ValidateRequest="false" %>
	...
	<body onload="CargarConfiguracion();" leftMargin="5" topMargin="5" rightMargin="5">
		<form id="Form1" method="post" runat="server">
			<table class="GG" cellSpacing="0" cellPadding="10" width="100%" align="center" border="0">
										...
										<TD>
											<TABLE id="tblDatosSolicitud" style="DISPLAY: none" cellSpacing="0" cellPadding="3" width="90%"
												...
												<TR>
													...
													<TD width="35%"><asp:label id="lblFechaCreacion" runat="server" CssClass="LabelNoModify" Width="200px"></asp:label><BR>
														<asp:label id="lblUsuarioCreacion" runat="server" CssClass="LabelNoModify"></asp:label></TD>
												</TR>
											</TABLE>
											<TABLE id="Table2" cellSpacing="0" cellPadding="3" width="90%" align="center">
												<TBODY>
													...
													<TR>
														...
														<TD>
															<asp:textbox id="txtPrestador" runat="server" CssClass="LabelNoModify" Width="200px" ></asp:textbox><BR>
				...
				<TR>
					<TD>Forma de Pago</TD>
					<TD><asp:textbox id="txtFormaPago" runat="server" CssClass="LabelNoModify" Width="200px"></asp:textbox></TD>
					<TD></TD>
					<TD></TD>
				</TR>
				<TR>
					...
					<TD></TD>
					<TD><asp:textbox id="txtDiagnostico" runat="server" CssClass="LabelNoModify" Width="170px"
							Visible="False"></asp:textbox>
						<asp:textbox id="txtIdDiagnostico" runat="server" Width="0px"></asp:textbox></TD>
				</TR>
				<TR>
					<TD>
						<P>Observaciones</P>
					...
					<TD colSpan="3">
						<asp:Label id="txtComentarioSolicitud" runat="server" CssClass="LabelNoModify"></asp:Label></TD>
				</TR>
				<TR>
					<TD>Documentos</TD>
					<TD colSpan="3">
				...
				<TR>
					...
					<TD colSpan="3">
						<asp:CheckBoxList id="chkAnotaciones" runat="server" Width="80%" RepeatColumns="1" Enabled="False"></asp:CheckBoxList></TD>
				</TR>
			</table>
			<P></P>
			<P></P>
							...
							<TABLE class="tableBorder" id="Table4" cellSpacing="0" cellPadding="8" width="100%" border="0">
								...
								<TR vAlign="top">
									<TD>
										...
										<asp:Label id="lblIdTipoServicio" Width="0" runat="server" Visible="false" text='<%# DataBinder.Eval(Container, "DataItem.IdTipoServicio") %>'>
										</asp:Label>
									<TD>
							...
							<TD width="275">
								<TABLE class="tableBorder" id="Table5" cellSpacing="0" cellPadding="5" width="275">
									<TR class="tableBorder">
										...
										<TD>
											<asp:Label id="lblTotalProductosServicios" runat="server"></asp:Label></TD>
									</TR>
									<TR>
										<TD>Total Aprobado</TD>
										<TD>
											<asp:Label id="lblTotalAprobado" runat="server"></asp:Label></TD>
									</TR>
									<TR>
										<TD>Total Facturas</TD>
										<TD>
											<asp:Label id="lblTotalFacturas" runat="server"></asp:Label></TD>
									</TR>
								</TABLE>
							</TD>
						</TR>
			...
			<TR>
				<TD align="center" colSpan="2">
					<FIELDSET class="FieldSet" style="WIDTH: 90%" id="fldFormatos" runat="server"><LEGEND><IMG src="../../iconos/icoPrint.gif" border="0">&nbsp;Formatos</LEGEND><BR>
								...
								<TD>
									<TABLE class="tableAllBorder" id="Table8" cellSpacing="0" width="95%" border="0">
										<TR>
											...
											<TD>
												<asp:HyperLink id="hplFormato" runat="server" CssClass="link">Imprimir</asp:HyperLink></TD>
										</TR>
										<TR>
											<TD>Resumen Solicitud</TD>
											<TD>
												<asp:HyperLink id="hplResumen" runat="server" CssClass="link">Imprimir</asp:HyperLink></TD>
										</TR>
									</TABLE>
											...
											<TABLE class="tableAllBorder" id="Table3" cellSpacing="0" cellPadding="8" width="100%"
												...
												<TR>
													<TD width="70%">Orden de
														...
														<asp:Label id="lblIdTipoServicioFormato" Visible="false" runat="server" text='<%# DataBinder.Eval(Container, "DataItem.IdTipoServicio") %>'>
														</asp:Label>
														<asp:Label id="lblIdProveedor" Visible="false" runat="server" text='<%# DataBinder.Eval(Container, "DataItem.IdProveedor") %>'>
														</asp:Label>
														<asp:Label id="lblUrlFormato" Visible="false" runat="server" text='<%# DataBinder.Eval(Container, "DataItem.URLFormato") %>'>
														</asp:Label>
													</TD>
													<TD>
														<asp:linkbutton CssClass="link" id=lnkImprimirFormato runat="server" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.IdSolicitudTipoServicio") %>' CommandName="Imprimir" ForeColor='<%#  !Convert.IsDBNull(DataBinder.Eval(Container, "DataItem.Impresiones")) && Convert.ToInt16(DataBinder.Eval(Container, "DataItem.Impresiones")) > 0 ? System.Drawing.Color.Purple : System.Drawing.Color.FromName("#002E63")%>'>Imprimir</asp:linkbutton>&nbsp;
