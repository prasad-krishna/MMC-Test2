namespace TPA.interfaz_empleado.WebControls
{
    ...
    /// </summary>
    public partial class WC_EncabezadoFormatoReembolso : WC_Base
    {
        ...
        public void LoadFormSolicitud(long p_idSolicitud, long p_idSolicitudTipoServicio, int p_idProveedor)
        {
            ...
            DateTime fechaLimite = Convert.ToDateTime(objTipoServicio.FechaFactura);
            this.lblFechaServicio.Text = fechaLimite.ToString("dd/MMMM/yyyy", System.Globalization.CultureInfo.CreateSpecificCulture("es-MX"));
