<%@ Page language="c#" Codebehind="FO_Medicamentos.aspx.cs" AutoEventWireup="false" Inherits="TPA.interfaz_empleado.formatos.FO_Medicamentos" %>
					...
					<TD align="center">
						<TABLE runat="server" class="tableFormato" id="tblInterior" cellSpacing="0" cellPadding="0"
							...
							<TBODY>
													...
													<TABLE class="tableBorderFormato" id="Table6" width="100%" border="0">
														...
														<TR>
															<TD align="center">________________________________<BR>
																<asp:Label id="lblUnidadAprobacion" runat="server"></asp:Label>
                                                                <br />
								...
								<TR>
									<TD class="textFormatoSmall" height="60">VIGENCIA DE&nbsp;
