...
{
    /// <summary>
    /// Formato de autorización para ordenes
    /// </summary>
    /// <remarks>Autor: Adriana Diazgranados
    /// </remarks>
    public partial class FO_MedicamentosOrdenCopias : PB_PaginaBase
    {
        ...
        protected override void Page_Load(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                this.tblPrincipal2.Style.Add("BACKGROUND-POSITION", "center center");
                this.tblPrincipal2.Style.Add("BACKGROUND-REPEAT", "no-repeat");
                this.tblPrincipal2.Style.Add("BACKGROUND-IMAGE", "url(../../logos/logoFondo_" + Session["Company"] + ".gif)");

                this.tblPrincipal3.Style.Add("BACKGROUND-POSITION", "center center");
                this.tblPrincipal3.Style.Add("BACKGROUND-REPEAT", "no-repeat");
                this.tblPrincipal3.Style.Add("BACKGROUND-IMAGE", "url(../../logos/logoFondo_" + Session["Company"] + ".gif)");
                ...
                if (!this.Page.IsPostBack)
                {
                    ...
                    this.WC_DiagnosticosFormato2.DesplegarDescripcion = false;
                    this.WC_EncabezadoFormatoOrden2.DesplegarPrestador = false;
                    this.WC_DiagnosticosFormato3.DesplegarDescripcion = false;
                    this.WC_EncabezadoFormatoOrden3.DesplegarPrestador = false;
        ...
        public void LoadFormSolicitud(long p_idSolicitud, long p_idSolicitudTipoServicio)
        {
            ...
            this.lblVigencia2.Text = objEmpresaTipoServicio.DiasVigencia.ToString();
            this.lblTextoCiudad2.Text = objEmpresaTipoServicio.TextoFormato;
            this.lblVigencia3.Text = objEmpresaTipoServicio.DiasVigencia.ToString();
            this.lblTextoCiudad3.Text = objEmpresaTipoServicio.TextoFormato;
            

            this.lblObservaciones.Text = objTipoServicio.Comentarios;
            this.lblObservaciones2.Text = objTipoServicio.Comentarios;
            this.lblObservaciones3.Text = objTipoServicio.Comentarios;
            ...
            this.lblMedico2.Text = objPrestador.NombrePrestador;
            this.lblIdentificacion2.Text = objPrestador.Nit;
            this.lblMedico3.Text = objPrestador.NombrePrestador;
            this.lblIdentificacion3.Text = objPrestador.Nit;


            /*MAHG 11/06/2010*/
            //Se agrega la cedula e institución del médico
            this.lblCedula.Text = "Céd. Prof.: " +  objPrestador.Cedula;
            this.lblCedula2.Text = "Céd. Prof.: " + objPrestador.Cedula;
            this.lblCedula3.Text = "Céd. Prof.: " + objPrestador.Cedula;
            //Fin MAHG 11/06/2010
            ...
            this.lblInstitucion2.Text = "Institución: " + objPrestador.Institucion;
            this.lblInstitucion3.Text = "Institución: " + objPrestador.Institucion;
        ...
        public void LoadGridDetail(long p_idSolicitud, long p_idSolicitudTipoServicio)
        {
            ...
            this.dtgDetalle2.DataSource = dtServicios;
            this.dtgDetalle2.DataBind();

            this.dtgDetalle3.DataSource = dtServicios;
            this.dtgDetalle3.DataBind();
        }
