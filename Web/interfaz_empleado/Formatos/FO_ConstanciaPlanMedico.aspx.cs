...
namespace TPA.interfaz_empleado.forma
{
    ...
    /// </summary>
    public partial class FO_ConstanciaPlanMedico : PB_PaginaBase
    {
        #region Atributos
            ...
            try
            {
                ...
                if (!this.Page.IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        Response.AddHeader("Content-Disposition", "attachment; filename=constancia_" + this.lblNombre.Text + ".doc");
