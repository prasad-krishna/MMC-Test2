...
namespace TPA.interfaz_empleado.forma
{
    ...
    /// </summary>
    public partial class LIS_solicitudinternet : PB_PaginaBase
    {
        ...
        public void FindSolicitudes()
        {
            ...
            this.dtgSolicitudes.DataSource = objSolicitud.ConsultSolicitudBusquedaInternet(dateFrom, dateUntil, idProveedor);
