...
{
    /// <summary>
    /// Inserta o modifica una solicitud de una autorización
    /// </summary>
    public partial class AE_solicitudautorizacion : PB_PaginaBase
    {
        ...
        public void LoadSolicitudServicios(SolicitudTipoServicio p_objTipoServicio, DataGrid p_dtgProductoServicio, int p_idTipoServicio, bool despliegaUVR)
        {
            ...
            foreach (DataGridItem item in p_dtgProductoServicio.Items)
            {
                ...
                txtProductoServicio.Attributes.Add("ReadOnly", "ReadOnly"); // PETF 14/01/10
                ...
                if (txtProductoServicio.Text.Trim() != string.Empty)
                {
                    ...
                    txtFechaPrestacion.Attributes.Add("ReadOnly", "ReadOnly"); //PETF 14/01/10
        ...
        {
            objSolicitud.IdSolicitud = Convert.ToInt64(Request.QueryString["IdSolicitudCopia"]);
        ...
        public void LoadSolicitudServiciosEstado(SolicitudTipoServicio p_objTipoServicio, long p_idSolicitudTipoServicio, short p_idEstado, short p_idMotivo)
        {
            ...
            foreach (DataRow item in dtServicios.Rows)
            {
                ...
                objServicioCarga.IdSolicitud = Convert.ToInt64(Request.QueryString["IdSolicitudCopia"]);
        ...
        public void LoadDiagnosticos(SolicitudTipoServicio p_objTipoServicio, DataListItem p_item)
        {
            ...
            WC_AdicionarDiagnostico1.LoadDiagnosticos(p_objTipoServicio, Convert.ToInt16(Solicitud.EnumTipoSolicitud.Autorizacion));
        }
        ...
        public ArrayList LoadProveedores(DataListItem p_item, int p_tipoServicio)
        {
            ...
            return WC_AdicionarPrestador1.LoadProveedores(p_tipoServicio, Convert.ToInt16(Solicitud.EnumTipoSolicitud.Autorizacion));
        }
        ...
        public void LoadFormSolicitud(long p_idSolicitud)
        {
            ...
            {
                Response.Redirect("AE_solicitudautorizacionresumen.aspx?IdSolicitud=" + p_idSolicitud + "&employee_id=" + Convert.ToInt32(Request.QueryString["employee_id"]));
            }
            else
            {
                if (Request.QueryString["IdSolicitudCopia"] != null)
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void ddlPrestador_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    if ((Request.QueryString["liquidacion"] != null && Request.QueryString["liquidacion"] != string.Empty) || (Request.QueryString["liquidacionConfirmacion"] != null && Request.QueryString["liquidacionConfirmacion"] != string.Empty))
                    {
                        ...
                        txtValorAprobado.TabIndex = Convert.ToInt16(e.Item.ItemIndex + 1);
                        ...
                        txtFechaPrestacion.Text = this.txtFecha.Text;
                    }
        ...
        private void dtlTipoServicio_ItemDataBound(object sender, System.Web.UI.WebControls.DataListItemEventArgs e)
        {
            try
            {
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    ddlAdicionarServicios.Items.Insert(0, new ListItem("--", "0"));
                        ...
                        || (Request.QueryString["IdSolicitudCopia"] != null && rowItem.ItemArray.Length > 0 && !Convert.IsDBNull(rowItem["IdSolicitudTipoServicio"]) && (long)rowItem["IdSolicitudTipoServicio"] != 0))
                    {
                        ...
                        ImageButton imbLiquidar = (ImageButton)e.Item.FindControl("imbLiquidar");
                        ...
                        DataTable dtProductoServicios = objSolicitudServicio.ConsultSolicitudServicio().Tables[0];

                        //Si viene de liquidación solamente lista el tipo de servicio a liquidar, permite el cambio de tipo de servicio
                        if (Request.QueryString["liquidacion"] != null && Request.QueryString["liquidacion"] != string.Empty)
                        {
                            ...
                            object[] lstObjetos = new object[0];
                            //Llenar espacios en blanco en grilla
                            for (int i = dtProductoServicios.Rows.Count; i < 10; i++)
                            {
                                dtProductoServicios.Rows.Add(lstObjetos);
                            }
                        }

                        dtgProductoServicio.DataSource = dtProductoServicios;
                        dtgProductoServicio.DataBind();

                        if (Request.QueryString["internet"] != null && Request.QueryString["internet"] != string.Empty)
                        {
                            ddlTipoServicio.Enabled = true;
                            object[] lstObjetos = new object[0];
                            int cantidadSuma = 10;
        ...
        private void dtlTipoServicio_ItemCommand(object source, System.Web.UI.WebControls.DataListCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "Liquidar")
                {
                    ...
                    this.OpenWindow("AE_liquidardetalleautorizacion.aspx?IdSolicitud=" + Request.QueryString["IdSolicitud"] + "&IdSolicitudTipoServicio=" + txtIdSolicitudTipoServicio.Text + "&IdTipoServicio=" + ddlTipoServicio.SelectedValue, 520, 470);
            ...
            try
            {
                if (Request.QueryString["IdSolicitud"] != null)
                {
                    ...
                    if (Request.QueryString["liquidacion"] != null && Request.QueryString["liquidacion"] != string.Empty)
                        ...
                        Response.Redirect("AE_solicitudautorizacionresumen.aspx?IdSolicitud=" + Convert.ToInt64(Request.QueryString["IdSolicitud"]) + "&employee_id=" + Request.QueryString["employee_id"] + "&popup=" + Request.QueryString["popup"] + "&liquidacionConfirmacion=" + Request.QueryString["liquidacion"] + "&reload=" + Request.QueryString["reload"]);
        ...
        protected void lnkVerHistorico_Click(object sender, System.EventArgs e)
        {
            if (this.ddlUsuario.SelectedValue == "0")
                ...
                this.OpenWindow("LIS_historicosolicitudservicios.aspx?beneficiario_id=" + this.ddlUsuario.SelectedValue, 850, 750);
        }
        ...
        private void imbGuardar_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            try
            {
                if (Request.QueryString["IdSolicitud"] != null)
                {
                    this.UpdateSolicitud(Convert.ToInt64(Request.QueryString["IdSolicitud"]));
                    this.RegisterLog(Log.EnumActionsLog.ModificarSolictudAutorizacion, Convert.ToInt64(Request.QueryString["IdSolicitud"]), "Modificación solicitud " + Convert.ToInt32(Request.QueryString["IdSolicitud"]) + " Estado Actual " + this.ddlEstadoSoli.SelectedItem.Text);
                    Response.Redirect("AE_solicitudautorizacion.aspx?IdSolicitud=" + Convert.ToInt64(Request.QueryString["IdSolicitud"]) + "&employee_id=" + Request.QueryString["employee_id"]);
                }
                else
                {
                    long idSolicitud = this.InsertSolicitud();
                    this.RegisterLog(Log.EnumActionsLog.IngresarSolictudAutorizacion, idSolicitud, "Modificación solicitud " + idSolicitud);
                    Response.Redirect("AE_solicitudautorizacion.aspx?IdSolicitud=" + idSolicitud + "&employee_id=" + Request.QueryString["employee_id"]);
                }
            }
            catch (Exception ex)
            {
