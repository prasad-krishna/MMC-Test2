...
namespace TPA.interfaz_empleado.forma
{
    ...
    /// </summary>
    public partial class AE_solicitudautorizacionresumen : PB_PaginaBase
    {
        #region Atributos
        ...
        public void LoadFormSolicitud(long p_idSolicitud)
        {
            ...
            this.hplFormato.NavigateUrl = "javascript:openPopUp('AE_solicitudautorizacionresumen.aspx?IdSolicitud=" + p_idSolicitud + "&employee_id=" + Request.QueryString["employee_id"] + "&Resumen=1',900,700)";
            this.hplResumen.NavigateUrl = "javascript:openPopUp('../Formatos/FO_ResumenImpresionAutorizacion.aspx?IdSolicitud=" + p_idSolicitud + "&employee_id=" + Request.QueryString["employee_id"] + "&Imprimir=1',829,900)";
        }
