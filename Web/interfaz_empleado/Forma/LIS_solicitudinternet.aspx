<%@ Page language="c#" Codebehind="LIS_solicitudinternet.aspx.cs" AutoEventWireup="false" Inherits="TPA.interfaz_empleado.forma.LIS_solicitudinternet" %>
	...
	<HEAD>
		...
		<script language="javascript">			
			...
			function ShowMenu(sender, idSolicitud, employee_id, tipoSolicitud, idConsulta, idEstado, siniestrTPAAnterior)
			{
				...
				if(tipoSolicitud == 1)
				{
					hplEditar.href = "AE_solicitudreembolso.aspx?IdSolicitud=" + idSolicitud  + "&employee_id=" + employee_id + "&internet=1"
				...
				else
				{
					if(tipoSolicitud == 2)
					{
						hplEditar.href = "AE_solicitudautorizacion.aspx?IdSolicitud=" + idSolicitud  + "&employee_id=" + employee_id + "&internet=1"
					...
					{
						hplEditar.href = "AE_solicitudorden.aspx?IdSolicitud=" + idSolicitud  + "&employee_id=" + employee_id + "&IdConsulta=" + idConsulta + "&internet=1"
	...
	<body onload="CargarConfiguracion();document.Form1.txtNoSolicitud.focus();">
		...
		<asp:ScriptManager ID="scrMng" runat="server"></asp:ScriptManager>
			<table class="GG" cellSpacing="0" cellPadding="1" width="100%" align="center" border="0">
				...
				<TR>
					<TD align="center" colSpan="2"><asp:updatePanel id="Ajaxpanel2" runat="server"><ContentTemplate><BR>
							<BR>
							<ASP:DATAGRID id="dtgSolicitudes" runat="server" CssClass="grid" Width="100%" PageSize="20" AllowPaging="True"
      ...
      src="../../images/icoMenu.gif">
									...
									<ASP:TEMPLATECOLUMN HeaderText="No. Solicitud">
										...
										<ITEMTEMPLATE>
											<ASP:HYPERLINK id=hplName runat="server" CssClass="textSmallBlack" NavigateUrl='<%# Convert.ToInt32(DataBinder.Eval(Container, "DataItem.IdTipoSolicitud")) == 1 ? "AE_solicitudreembolso.aspx?IdSolicitud=" + DataBinder.Eval(Container, "DataItem.IdSolicitud") + "&amp;employee_id=" + DataBinder.Eval(Container, "DataItem.id_empleado") + "&amp;internet=1"  : Convert.ToInt32(DataBinder.Eval(Container, "DataItem.IdTipoSolicitud")) == 2 ? "AE_solicitudautorizacion.aspx?IdSolicitud=" + DataBinder.Eval(Container, "DataItem.IdSolicitud") + "&amp;employee_id=" + DataBinder.Eval(Container, "DataItem.id_empleado") + "&amp;internet=1" :  "AE_solicitudorden.aspx?IdSolicitud=" + DataBinder.Eval(Container, "DataItem.IdSolicitud") + "&amp;employee_id=" + DataBinder.Eval(Container, "DataItem.id_empleado") + "&amp;IdConsulta=" +  DataBinder.Eval(Container,"DataItem.IdConsulta") + "&amp;internet=1" %>'>
