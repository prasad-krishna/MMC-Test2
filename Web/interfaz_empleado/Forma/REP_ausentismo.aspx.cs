...
{
    /// <summary>
    /// Genera el reporte de ausentismo
    /// </summary>
    public partial class REP_ausentismo : PB_PaginaBase
    {
        ...
        protected void btnEnviar_Click(object sender, EventArgs e)
        {
            ...
            gvReporte.DataSource = objIncapacidad.ListIncapacidadAusentismo(dateFrom, dateUntil, empresas, sedes, usuarios, medicos);
            gvReporte.DataBind();
